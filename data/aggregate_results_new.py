...
def main():
    ...
    base_output_dir = args.output_dir if args.output_dir else "analysis_output"
    date_output_dir = os.path.join(base_output_dir, current_date)
    output_dir = os.path.join(date_output_dir, f"aggregation_{timestamp}")
    ...
    json_output = os.path.join(output_dir, 'detailed_results.json')
